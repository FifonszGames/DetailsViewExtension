...
TSharedRef<ITableRow> SPropertyPathsPicker::OnGenerateRow(TSharedPtr<FPropertyPathNode> InItem, const TSharedRef<STableViewBase>& OwnerTable)
{
...
void SPropertyPathsPicker::OnPropertyPathCheckStatusChanged(ECheckBoxState CheckBoxState, TSharedPtr<FPropertyPathNode> PropertyPathNode) const
{
...
void SPropertyPathsPicker::OnGetChildren(TSharedPtr<FPropertyPathNode> InItem, TArray<TSharedPtr<FPropertyPathNode>>& OutChildren)
{
